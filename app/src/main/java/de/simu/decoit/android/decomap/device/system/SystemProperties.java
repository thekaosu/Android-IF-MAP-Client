/* 
 * SystemProperties..java          0.3 2015-03-08
 * 
...
public class SystemProperties {
    ...
    private String executeTop() {
        ...
        try {
            ...
            Toolbox.logTxt(this.getClass().getName(), "error in getting first line of top: " + e);
        } finally {
            try {
                if (in != null) {
                    in.close();
                ...
                Toolbox.logTxt(this.getClass().getName(),
                        "error in closing and destroying top process: " + e);
            }
        }
        return returnString;
    }
    ...
    private int getTotalMemoryAmountInMB() {
        ...
        try {
            ...
            Toolbox.logTxt(this.getClass().getName(), "IO eception while reading total memory amount: " + ex);
        } finally {
            if (reader != null) {
                try {
                    reader.close();
                } catch (IOException ex) {
                    Toolbox.logTxt(this.getClass().getName(), "error while closing reader: " + ex);
                }
            }
        }
    ...
    public String getSelinuxStatus() {
        ...
        if (execPath != null) {
            ...
            try {
                ...
                Toolbox.logTxt(this.getClass().getName(), "error in getting getenforce: " + e);
            } finally {
                try {
                    if (in != null) {
                        in.close();
                    ...
                    Toolbox.logTxt(this.getClass().getName(),
                            "error in closing and destroying getenforce process: " + e);
                }
            }
        } else {
    ...
    private String getPathOfBin(String file) {
        String path = null;
        List<String> paths = new ArrayList<>(Arrays.asList(System.getenv("PATH").split(
