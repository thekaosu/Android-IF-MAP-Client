/*
 * SynchronousRunnable.java        0.2 2015-03-08
 *
 ...
 * @version 0.2
 */
class SynchronousRunnable extends ResponseRunnable {
     ...
     */
    public SynchronousRunnable(IFMapMonitoring monitor) {
        super(monitor);
    }
    ...
    public void run() {
        ...
        if (IFMapMonitoring.sBoundRenewConnService != null) {
            monitor.mIsBound = UnbinderClass.doUnbindConnectionService(
                    monitor.activity.getApplicationContext(), monitor.mConnection, monitor.myProgressDialog,
                    monitor.mIsBound);
